...
from players import fixed_player, kelly_player
...
def create_mock_verdict_approved() -> Verdict:
    ...
    participant = Participant(strategy="RSIReversion", bucket="BBW=L|RS1|H=M", symbol="BTCUSDT", timeframe="15m")
    ...
    return Verdict(
        ...
        meta={"timestamp": "2024-01-01T12:00:00", "symbol": "BTCUSDT", "timeframe": "15m"},
    )
