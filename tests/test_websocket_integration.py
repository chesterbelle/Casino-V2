...
class TestTableCCXTProWebSocket:
    ...
    def table(self, mock_exchange):
        ...
        with patch("tables.table_ccxt_pro.ccxtpro") as mock_ccxtpro:
            ...
            table = TableCCXTPro(exchange_id="kraken", symbols=["BTC/USDT", "ETH/USDT"], timeframe="1m", testnet=True)
            return table
    ...
    async def test_start_listening_processes_ohlcv_updates(self, table, mock_exchange):
        ...
        mock_messages = [
            {"symbol": "BTC/USDT", "ohlcv": [1640995200000, 50000.0, 51000.0, 49000.0, 50500.0, 100.0]},
            {"symbol": "ETH/USDT", "ohlcv": [1640995200000, 3000.0, 3100.0, 2900.0, 3050.0, 200.0]},
        ]
