...
class StochasticReversion:
    def __init__(
        self, k_period: int = 14, d_period: int = 3, low_threshold: float = 20.0, high_threshold: float = 80.0
    ):
        """
        Args:
    ...
    def check_signal(self, candle: dict):
        ...
        if k < self.low_threshold and d < self.low_threshold:
            return {
                ...
                "side": "LONG",
                "range_score": 1,
                "features": {"stoch_k": k, "stoch_d": d, "stoch_state": "oversold"},
            }
        ...
        if k > self.high_threshold and d > self.high_threshold:
            return {
                ...
                "side": "SHORT",
                "range_score": 1,
                "features": {"stoch_k": k, "stoch_d": d, "stoch_state": "overbought"},
            }
